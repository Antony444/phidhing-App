...
for key,values in result.items():
    ...
    if verdict == 'File-Clean':
        verdict = colorama.Fore.GREEN + 'File-Clean'
...
if malicious_count != 0:
    ...
    type(colorama.Back.WHITE + colorama.Fore.GREEN + f'\t\t\t\t No antivirus (SandBox) found the given file malicious !!')
